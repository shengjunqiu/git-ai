...
- [ ] 使用管理员账号登录 Dashboard。
- [ ] 使用普通开发者账号登录 Dashboard。
- [ ] 记录 Desktop、Tablet、Mobile 三个 viewport：
...
- [ ] 对总览、部门、用户管理、发布管理和帮助页截图。
- [ ] 使用 Network 面板记录初次加载资源大小和请求数。
- [ ] 使用 Performance 面板记录一次总览加载和一次 60 秒自动刷新。
- [ ] 模拟慢速网络、离线、401、403 和 500。
- [ ] 记录键盘 Tab 顺序和模态框行为。
...
- [ ] 已保存优化前截图或录屏。
- [ ] 已记录移动端导航不可用的现状。
- [ ] 已记录初次加载、自动刷新和部门数据请求基线。

### 0.4 建立功能清单

- [ ] 列出所有 12 个 Dashboard 栏目及角色权限。
- [ ] 列出所有管理 mutation：创建、删除、授权、撤销、上传、发布和设置。
- [ ] 列出所有认证相关页面。
- [ ] 列出页面依赖的外部资源和硬编码部署地址。
