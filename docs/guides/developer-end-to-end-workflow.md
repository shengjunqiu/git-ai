...
```bash
curl http://117.147.213.234:38080/health
```
...
SERVER="http://117.147.213.234:38080"
...
| 信息 | 示例 |
| --- | --- |
| 服务端地址 | `http://117.147.213.234:38080` |
| install nonce | `8b1c...` |
...
```text
API Base URL: http://117.147.213.234:38080
